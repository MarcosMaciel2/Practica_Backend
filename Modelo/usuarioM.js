...
// UconsultaAbd.createUser = function (usuario, funcallback) {
//     consulta = "INSERT INTO usuario (mail, nickname, clave) VALUES (?,?,?);";
//     params = [usuario.mail, usuario.nickname, usuario.clave];
...
//             if (err.code == "ER_DUP_ENTRY") {
//                 funcallback({
//                     mensajito: "Ya se ah registrado este usuario",
//                     detalle: err
//                 });
//             } else {
//                 funcallback({
//                     mensajito: "Otro error",
//                     detalle: err
//                 });
//             }
//         } else {
